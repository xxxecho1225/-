...
url = 'http://bkzs.ahu.edu.cn/static/front/ahu/basic/html_web/lnfs.html'
...
def saveIntoXlsx(data, province_name, year_name):
    ...
    # 保存工作簿到文件
    filename = f"{year_name}-{province_name}-安徽大学.csv"
    os.makedirs('学校信息\安徽大学', exist_ok=True)
    wb.save(os.path.join('学校信息\安徽大学', filename))
