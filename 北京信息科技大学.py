...
url = 'https://zhaoshengcx.bistu.edu.cn/static/front/bistu/basic/html_web/lnfs.html'
...
def saveIntoXlsx(data, province_name, year_name):
    ...
    # 保存工作簿到文件
    filename = f"{year_name}-{province_name}-北京信息科技大学.csv"
    os.makedirs('学校信息\北京信息科技大学', exist_ok=True)
    wb.save(os.path.join('学校信息\北京信息科技大学', filename))
