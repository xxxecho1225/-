...
url = 'https://sjcx.dlmu.edu.cn/static/front/dlmu/basic/html_web/lnfs.html'
...
def saveIntoXlsx(data, province_name, year_name):
    ...
    # 保存工作簿到文件
    filename = f"{year_name}-{province_name}-大连海事大学.csv"
    os.makedirs('学校信息\大连海事大学', exist_ok=True)
    wb.save(os.path.join('学校信息\大连海事大学', filename))
