...
url = 'https://zsb.hrbeu.edu.cn/static/front/hrbeu/basic/html_web/lnfs.html'
...
def saveIntoXlsx(data, province_name, year_name):
    ...
    # 保存工作簿到文件
    filename = f"{year_name}-{province_name}-哈尔滨工程大学.csv"
    os.makedirs('学校信息\哈尔滨工程大学', exist_ok=True)
    wb.save(os.path.join('学校信息\哈尔滨工程大学', filename))
