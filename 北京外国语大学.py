...
url = 'https://zhaosheng.bfsu.edu.cn/static/front/bfsu/basic/html_web/lnfs.html?20220331'
...
def saveIntoXlsx(data, province_name, year_name):
    ...
    # 保存工作簿到文件
    filename = f"{year_name}-{province_name}-北京外国语大学.csv"
    os.makedirs('学校信息\北京外国语大学', exist_ok=True)
    wb.save(os.path.join('学校信息\北京外国语大学', filename))
